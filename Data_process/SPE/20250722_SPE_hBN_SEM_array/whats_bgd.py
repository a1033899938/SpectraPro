...
fig, axes = draw_cascade_group_2d(xs_group=xs_group, ys_group=ys_group, les_sg=les_sg, les_group=les_group, colors_group=colors_group, space = 0.1, axis = 0, figsize=None)
