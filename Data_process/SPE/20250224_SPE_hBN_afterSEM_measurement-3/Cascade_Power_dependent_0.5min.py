...
if __name__ == '__main__':
    ...
    with h5py.File(datapath1, "r") as f:
        ...
        keys_afterSEM = []
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_10uW_1')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_20uW_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_50uW_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_100uW_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_200uW_1')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_500uW_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_1000uW_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_2000uW_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_3000uW_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_2000uW_back_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_1000uW_back_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_500uW_back_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_200uW_back_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_100uW_back_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_50uW_back_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_20uW_back_2')
        keys_afterSEM.append('hBN_afterSEM_5kV_0.5min_10uW_back_0')
    ...
    title = f'hBN-after-SEM-process_5kV_0.5min\n Excitation power-dependent PL spectra'
    ...
    plt.savefig(r'D:\ExpData\SPE\20250224_SPE_hBN_afterSEMprocess\measurement-3\0.5min\0.5min_cascade\\20250224_SPE_hBN_afterSEM_measurement-3_logI.png')
    # plt.savefig(r'D:\ExpData\SPE\20250224_SPE_hBN_afterSEMprocess\measurement-3\0.5min\0.5min_cascade\\20250224_SPE_hBN_afterSEM_measurement-3.png')
