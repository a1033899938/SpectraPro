...
filefolder = r"D:\ExpData\SPE\20250917RenishawRaman\XJJ\20250917\20250702-1#"
filters = ['.spc', '.wdf']
...
nums = []
for file in files:
    if "hBN_without_EBI" in file and "(" not in file:
...
fig.suptitle("hBN w/o EBI", fontsize=30, fontweight='bold', y=1)
the_graph1(ax1)
the_graph1(ax2)
the_graph2(ax3)
