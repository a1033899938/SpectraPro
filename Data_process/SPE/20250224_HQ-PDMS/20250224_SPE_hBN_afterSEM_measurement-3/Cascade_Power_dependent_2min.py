...
if __name__ == '__main__':
    ...
    with h5py.File(datapath1, "r") as f:
        ...
        keys_afterSEM = []
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_10uW_2')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_20uW_1')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_50uW_1')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_100uW_1')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_200uW_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_500uW_shut10min_and_measure_again_andAdjustFocus_3')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_1000uW_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_2000uW_1')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_3000uW_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_2000uW_back_1')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_1000uW_back_0')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_500uW_back_1')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_200uW_back_1')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_100uW_back_1')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_50uW_back_1')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_20uW_back_1')
        keys_afterSEM.append('hBN_afterSEM_5kV_2min_10uW_back_0')
    ...
    title = f'hBN-after-SEM-process_5kV_2min\n Excitation power-dependent PL spectra'
    ...
    # plt.savefig(r'D:\ExpData\SPE\20250224_SPE_hBN_afterSEMprocess\measurement-3\2min\2min_cascade\\20250224_SPE_hBN_afterSEM_measurement-3_logI.png')
    # plt.savefig(r'D:\ExpData\SPE\20250224_SPE_hBN_afterSEMprocess\measurement-3\2min\2min_cascade\\20250224_SPE_hBN_afterSEM_measurement-3.png')
    ...
    with h5py.File(datapath1, "r") as f:
        data = f['OceanOpticsSpectrometer']
        keys_afterSEM_1 = []
        keys_afterSEM_1.append('hBN_afterSEM_5kV_2min_500uW_0')
        keys_afterSEM_1.append('hBN_afterSEM_5kV_2min_500uW_1')
        keys_afterSEM_1.append('hBN_afterSEM_5kV_2min_500uW_2')
        keys_afterSEM_1.append('hBN_afterSEM_5kV_2min_500uW_3')


        keys_afterSEM_2 = []
        keys_afterSEM_2.append('hBN_afterSEM_5kV_2min_500uW_shut10min_and_measure_again_andAdjustFocus_0')
        keys_afterSEM_2.append('hBN_afterSEM_5kV_2min_500uW_shut10min_and_measure_again_andAdjustFocus_1')
        keys_afterSEM_2.append('hBN_afterSEM_5kV_2min_500uW_shut10min_and_measure_again_andAdjustFocus_2')
        keys_afterSEM_2.append('hBN_afterSEM_5kV_2min_500uW_shut10min_and_measure_again_andAdjustFocus_3')

        sps_1 = []
        for idx, key in enumerate(keys_afterSEM_1):
            sp = data[key]
            bgd = np.array(sp.attrs['background'])
            wav = np.array(sp.attrs['wavelengths'])
            sp_time = sp.attrs['integration_time'] / 1000
        ...
        sps_TRPL = data['500uW_time_series_0']
        bgd, _ = np.meshgrid(bgd, np.arange(0, sps_TRPL.shape[0]))
        sps_TRPL = sps_TRPL - bgd

        # sps_2 = []
        # for idx, key in enumerate(keys_afterSEM_2):
        #     sp = data[key]
        #     bgd = np.array(sp.attrs['background'])
        #     wav = np.array(sp.attrs['wavelengths'])
        #     sp_time = sp.attrs['integration_time'] / 1000
        ...
        #     sps_2.append(sp)
        #
        # sps_tot = np.concatenate((sps_1, sps_TRPL, sps_2),axis=0)

        sps_tot = np.concatenate((sps_1, sps_TRPL), axis=0)
        x = wav
        y = np.arange(sps_tot.shape[0])
        Z = np.array(sps_tot)
        ...
        set_figure.set_tick(ax1, xbins=6, ybins=10, fontsize=10, fontweight='bold',
                            linewidth=3, tick_pad=5, direction='in',
                            ticks_xlabel=np.arange(0, len(y), 2),
                            ticks_ylabel=np.arange(400, 901, 100), mode='3d')  # Normalized
        ax1.set_xlabel(xlabel='Measurement  sequence', labelpad=15)
        ax1.set_ylabel(ylabel='Wavelength(nm)', labelpad=15)
        ax1.zaxis.set_rotate_label(False)
        ax1.set_zlabel(zlabel='Intensity(counts)', rotation=90, labelpad=15)

        ax1.set_box_aspect([1, 1, 1])
        ax1.view_init(elev=20, azim=45)  # elev 是仰角，azim 是方位角
        # plt.tight_layout()
        ax1.grid(True)

        # from src.general.save_figure import save_subfig
        # plt.savefig(fr'D:\ExpData\SPE\20250224_SPE_hBN_afterSEMprocess\measurement-3\2min\2min_cascade\20250224_SPE_hBN_afterSEM_measurement-3_5kV_2min_500uW_TRPL.png.png')
    plt.show()