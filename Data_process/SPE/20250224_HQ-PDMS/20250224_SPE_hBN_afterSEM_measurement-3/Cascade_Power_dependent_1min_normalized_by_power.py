...
if __name__ == '__main__':
    ...
    with h5py.File(datapath1, "r") as f:
        ...
        legend_labels_afterSEM = ['10uW', '20uW', '50uW', '100uW', '500uW', '1000uW', '2000uW', '3000uW',
                                  ...
                                  '20uW*', '10uW*']
        power_afterSEM = [10, 20, 50, 100, 500, 1000, 2000, 3000,
    ...
    # plt.tight_layout()
    plt.savefig(r'D:\ExpData\SPE\20250224_SPE_hBN_afterSEMprocess\measurement-3\1min\1min_cascade\\20250224_SPE_hBN_afterSEM_measurement-3_normalized_by_power.png')
