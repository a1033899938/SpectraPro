...
def the_figure1(ax1):
    ...
    set_figure.set_tick(ax1, ybins=0, ticks_xlabel=np.arange(0, 7001, 2000))
...
#
#     keys = ['hBN_afterSEM_5kV_5min_60KX_time_series_m5_P10uW_0',
#             'hBN_afterSEM_5kV_5min_60KX_time_series_m5_P20uW_0',
#             'hBN_afterSEM_5kV_5min_60KX_time_series_m5_P30uW_0',
#             'hBN_afterSEM_5kV_5min_60KX_time_series_m5_P50uW_0',
#             'hBN_afterSEM_5kV_5min_60KX_time_series_m5_P100uW_0',
#             'hBN_afterSEM_5kV_5min_60KX_time_series_m5_P200uW_0',
#             'hBN_afterSEM_5kV_5min_60KX_time_series_m5_P300uW_0',
#             'hBN_afterSEM_5kV_5min_60KX_time_series_m5_P500uW_0',
#             'hBN_afterSEM_5kV_5min_60KX_time_series_m5_P1000uW_1',
#             'hBN_afterSEM_5kV_5min_60KX_time_series_m5_P2000uW_0',
#             'hBN_afterSEM_5kV_5min_60KX_time_series_m5_P3000uW_0',
#             'hBN_afterSEM_5kV_5min_60KX_time_series_m5_P5000uW_0',
#             'hBN_afterSEM_5kV_5min_60KX_time_series_m5_P6000uW_0',
#             'hBN_afterSEM_5kV_5min_60KX_time_series_m5_P7000uW_0']
#
#     powers = []
#     ints = []
#     errors = []
...
#             ax.plot(x_for_fit, y_fit3, 'm--', label='Fitted lorentzian', linewidth=2)
#
#             the_figure(ax, key)
#             plt.tight_layout()
#             if save_fig == 1:
#                 plt.savefig(os.path.join(os.path.dirname(datapath1), 'curve_fit-5', f'power_dependent_PL_curve_fit-{key}-No{row}.png'))
#
#             plt.close(fig)
...
"""读取数据"""
powers, ints, errors = read_lines_txt(r"D:\ExpData\SPE\20250224_SPE_hBN_afterSEMprocess\measurement-6\powers_ints-5.txt")
"""保存PL线形拟合数据"""
# save_lines_txt(powers, ints, errors, save_full_path=os.path.join(os.path.dirname(datapath1), 'powers_ints-5.txt'))
...
if save_fig == 1:
    plt.savefig(os.path.join(os.path.dirname(datapath1), 'curve_fit-5', f'power_dependent_intensity_of_peak-1_log.png'))
    # plt.savefig(os.path.join(os.path.dirname(datapath1), 'curve_fit-5', f'power_dependent_intensity_of_peak-1.png'))
plt.show()