...
datapath1 = r"D:\ExpData\SPE\20250224_SPE_hBN_afterSEMprocess\measurement-9\20250224_SPE_hBN_afterSEM_measurement-9(2).h5"

"""fig0"""
# with h5py.File(datapath1, "r") as f:
#     mapping_name = 'hBN_afterSEM_mapping_0'
...
#
# np.save(os.path.join(os.path.dirname(datapath1), fr'm1\mapping_538.npy'), mapping)

save_fig = 0
mapping =np.load(os.path.join(os.path.dirname(datapath1), fr'm2\mapping_538.npy'))
