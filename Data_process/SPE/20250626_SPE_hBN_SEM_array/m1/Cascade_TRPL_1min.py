...
if __name__ == '__main__':
    ...
    def the_figure0(ax):
        """拟合曲线"""
        set_figure.set_label_and_title(ax, title=f'Time-Resolved PL-2mW', xlabel='Time(s)', ylabel='Wavelength(nm)', zlabel='Intensity(cts)', zlabel_rotation=90, mode='3d', x_label_pad=25, xlabel_rotation=-30, z_label_pad=20, title_pad=0)
    ...
    with h5py.File(datapath1, "r") as f:
        ...
        keys_time_resolution = ['hBN_after_SEM_array_point-2_450ex_2mW_0']

        for idx, key in enumerate(keys_time_resolution):
