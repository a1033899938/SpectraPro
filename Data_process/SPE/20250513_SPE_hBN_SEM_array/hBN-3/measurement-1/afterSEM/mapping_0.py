...
with h5py.File(datapath1, "r") as f:
    mapping_name = 'hBN_3_afterSEM_mapping_0'
...
np.save(os.path.join(os.path.dirname(datapath1), fr'm1\afterSEM_0.npy'), mapping)

"""保存图片"""
save_fig = 1
mapping =np.load(os.path.join(os.path.dirname(datapath1), fr'm1\afterSEM_0.npy'))
...
if save_fig == 1:
    fig.savefig(os.path.join(os.path.dirname(datapath1), f'm1\PL_afterSEM_0.png'))
    fig0.savefig(os.path.join(os.path.dirname(datapath1), f'm1\PL_mapping_afterSEM_0.png'))
plt.show()