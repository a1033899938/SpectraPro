...
with h5py.File(datapath1, "r") as f:
    mapping_name = 'hBN_1-2_afterSEM_mapping_0'
...
np.save(r"D:\ExpData\SPE\20250513_SPE_hBN_SEM_array\hBN-1-2\m1\after_SEM.npy", mapping)

"""保存图片"""
save_fig = 0
mapping =np.load(r"D:\ExpData\SPE\20250513_SPE_hBN_SEM_array\hBN-1-2\m1\after_SEM.npy")
...
if save_fig == 1:
    fig.savefig(r"D:\ExpData\SPE\20250513_SPE_hBN_SEM_array\hBN-1-2\m1\PL_afterSEM.png")
    fig0.savefig(r"D:\ExpData\SPE\20250513_SPE_hBN_SEM_array\hBN-1-2\m1\PL_mapping_afterSEM.png")
plt.show()