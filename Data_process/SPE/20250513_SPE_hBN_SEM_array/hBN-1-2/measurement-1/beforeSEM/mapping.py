...
np.save(r"D:\ExpData\SPE\20250513_SPE_hBN_SEM_array\hBN-1-2\m1\before_SEM.npy", mapping)

"""保存图片"""
save_fig = 1
mapping =np.load(r"D:\ExpData\SPE\20250513_SPE_hBN_SEM_array\hBN-1-2\m1\before_SEM.npy")
...
if save_fig == 1:
    fig.savefig(r"D:\ExpData\SPE\20250513_SPE_hBN_SEM_array\hBN-1-2\m1\PL_beforeSEM.png")
    fig0.savefig(r"D:\ExpData\SPE\20250513_SPE_hBN_SEM_array\hBN-1-2\m1\PL_mapping_beforeSEM.png")
plt.show()