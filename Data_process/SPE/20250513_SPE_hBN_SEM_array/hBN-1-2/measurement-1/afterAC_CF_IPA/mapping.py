...
with h5py.File(datapath1, "r") as f:
    mapping_name = 'hBN_1-2_afterAC-CF-IPA_mapping_0'
    ...
    for i in range(mapping_range[0]):
        ...
        for j in range(mapping_range[1]):
            ...
            # if mapping_5[i][j] > 1200:
            # mapping_5[i][j] = sp[find_val_idx(wav, choose_wav)]
the_figure(ax)

np.save(fr"D:\ExpData\SPE\20250513_SPE_hBN_SEM_array\hBN-1-2\m1\afterAC-CF-IPA_{choose_wav}.npy", mapping)

"""保存图片"""
save_fig = 1
mapping =np.load(fr"D:\ExpData\SPE\20250513_SPE_hBN_SEM_array\hBN-1-2\m1\afterAC-CF-IPA_{choose_wav}.npy")
...
if save_fig == 1:
    fig.savefig(r"D:\ExpData\SPE\20250513_SPE_hBN_SEM_array\hBN-1-2\m1\PL_afterAC-CF-IPA.png")
    fig0.savefig(r"D:\ExpData\SPE\20250513_SPE_hBN_SEM_array\hBN-1-2\m1\PL_mapping_afterAC-CF-IPA.png")
plt.show()