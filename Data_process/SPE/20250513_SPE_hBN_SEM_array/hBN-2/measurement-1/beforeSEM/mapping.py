...
#     mapping_name = 'hBN_2_beforeSEM_mapping_0'
...
#             if np.max(sp[find_val_idx(wav, 600):find_val_idx(wav, 650)]) > 100:
...
# the_figure(ax)
#
# np.save(os.path.join(os.path.dirname(datapath1), fr'm1\before_SEM.npy'), mapping_5)
