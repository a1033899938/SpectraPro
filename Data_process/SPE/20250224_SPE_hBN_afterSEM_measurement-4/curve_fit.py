...
if __name__ == '__main__':
    ...
    with h5py.File(datapath1, "r") as f:
        ...
        for key in data.keys():
            ...
            try:
                ...
                bounds = ([0, 535, 0,
                          ...
                          [100000, 540, 10,
                            100000, 565, 100,
                            100000, 580, 10])
                min_differences_for_fit = np.abs(wav - 520)
            ...
            # plt.savefig(fr'D:\ExpData\SPE\20250224_SPE_hBN_afterSEMprocess\measurement-4\curve_fit\20250224_SPE_hBN_afterSEM_measurement4_curve_fit-{key}.png')
