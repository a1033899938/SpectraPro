...
save_fig = 1
folder_path = r"D:\ExpData\ChenGroup\FS\20250331"
keys = ['WS2_0CW_532ex500uW-2.spe',
        'WS2_620CW_532ex500uW-2.spe']
le = ['WS2-suspended', 'WS2-supported']
extensions = ['.spe']
for i, key in enumerate(keys):
    ...
    if i == 0:
        ...
        readFile = read_file(data_path, strip=[49, 54], show_data_flag=False)
        data = readFile.data
        x = data['wavelength']
        y = data['intensity']
