...
folder_path = r'C:\Users\a1033\Desktop\Contemporary\240806-240808\20240913process\out4'
extensions = ['.txt', '.spe']
...
for file_path, file_name in zip(file_paths, file_names):
    ...
    if i == 1:
        ...
        text_x = 680
        text_y = 0.157
    set_figure.set_text(ax, x_text=text_x - 10, y_text=text_y, text=texts[i],
...
figure
'''
set_figure.set_label_and_title(ax, title=title, ylabel='Normalized Intensity(a.u.)',
...
set_figure.set_tick(ax, xbins=6, ybins=10, fontsize=15, fontweight='bold',
                    ...
                    ticks_xlabel=np.linspace(500, 800, 7),
                    ticks_ylabel=np.linspace(0, 1, 6))
print(np.linspace(0, 1, 10))
ax.set_xlim([figure_xmin, figure_xmax])
ax.set_ylim([figure_ymin/figure_ymax, 1.18])
save_subfig(fig, ax, r'C:\Users\a1033\Desktop\Contemporary\240806-240808\temp\fig4.png')
