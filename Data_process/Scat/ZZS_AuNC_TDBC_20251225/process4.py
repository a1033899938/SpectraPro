...
filepath = r"D:\ExpData\NP_scattering_Dispersion\ZZS_AuNC_TDBC_20251225\20251225_AuNC_TDBC.h5"
process_types = ["before_achro", "after_achro"]
roots = ["", "OceanOpticsSpectrometer/20251227_after_achro_2"]
    ...
    if not if_import_data:
        if iType == 1:
            with h5py.File(filepath, "r") as f:
                sp = f["OceanOpticsSpectrometer/ref_200ms_subtrate_bgd_1"]
