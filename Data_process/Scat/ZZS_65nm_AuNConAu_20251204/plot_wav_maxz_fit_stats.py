...
with h5py.File(filepath, "r") as f:
    for iType, process_type in enumerate(process_types):
        ...
        for iSection in range(2):
            ...
            my_wav_maxz_fit_slope_stats(ax, title=f"{process_type}_Fitted slope: {fit_range[iSection][0]:.1f} - {fit_range[iSection][1]:.1f} nm")
            ...
            my_wav_maxz_minimum_required_time_stats(ax, title=f"{process_type}_Minimum Required Time: {fit_range[iSection][0]:.1f} - {fit_range[iSection][1]:.1f} nm")
