...
folder_paths = [r'D:\XmuNetDisk\20241205RenishawDFS\Spectra\20241205\SHINs1#',
                r'D:\XmuNetDisk\20241205RenishawDFS\Spectra\20241205\SHINs2#',
                r'D:\XmuNetDisk\20241205RenishawDFS\Spectra\20241205\Tetrahedron1#',
                r'D:\XmuNetDisk\20241205RenishawDFS\Spectra\20241205\Tetrahedron2#']
...
for file_path, file_name in zip(file_paths, file_names):
    if 'Au' in file_name:
        ...
        subs.append(RF.data0['intensity'])
    else:
        RF = read_file(file_path, strip='all', show_data_flag=False)
