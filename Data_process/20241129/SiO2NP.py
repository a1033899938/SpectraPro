...
title = f'SiO2 NP-Contrast DFS-Normalized'  # Normalized
...
#     if 'SiO2NP-1' in legend_labels[idx] or 'SiO2NP-2' in legend_labels[idx]:
#         popt, pcov = curve_fit(double_gaussian, wav, sp, p0=[1000, 640, 100, 1000, 700, 100])
#         # 拟合参数
...
#     else:
#         popt, pcov = curve_fit(gaussian, wav, sp, p0=[2000, 700, 300])
