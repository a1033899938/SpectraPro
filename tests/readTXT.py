...
from src.save_figure import save_subfig
...
folder_path = r'C:\Users\a1033\Desktop\Contemporary\240806-240808\temp\out1'
extensions = ['.txt', '.spe']
...
for file_path, file_name in zip(file_paths, file_names):
    ...
    #     text_x = 545
    #     text_y = 300
    set_figure.set_text(ax, x_text=text_x - 10, y_text=text_y + 0.3, text=texts[i],
                        font='Times New Roman', fontweight='bold', fontsize=17, color=colors[i])
...
legend
'''
legend = set_figure.set_legend(ax, legend_labels=legend_text, font='Times New Roman', font_size=12,
                      location='upper left')
...
save_subfig(fig, ax, r'C:\Users\a1033\Desktop\Contemporary\240806-240808\temp\fig1.png')
