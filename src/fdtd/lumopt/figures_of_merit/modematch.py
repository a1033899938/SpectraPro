...
class ModeMatch(object):
    ...
    def __init__(self, monitor_name, mode_number, direction, multi_freq_src = False, target_T_fwd = lambda wl: np.ones(wl.size), norm_p = 1, target_fom = 0, rotation_angle_theta = 0, rotation_angle_phi = 0, rotation_offset = 0):
