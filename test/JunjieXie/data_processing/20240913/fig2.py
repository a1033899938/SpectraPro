...
folder_path = r'C:\Users\a1033\Desktop\Contemporary\240806-240808\temp\out2'
extensions = ['.txt', '.spe']
...
set_figure.set_tick(ax, xbins=6, ybins=10, fontsize=15, fontweight='bold',
                    linewidth=3, tick_pad=5, direction='in', ticks_xlabel=np.linspace(500, 800, 7))
...
save_subfig(fig, ax, r'C:\Users\a1033\Desktop\Contemporary\240806-240808\temp\fig2.png')
